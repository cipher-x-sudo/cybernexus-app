...
% CyberNexus Table of Contents styling (Beautiful Enhanced Design)
% Chapter styling - Large, bold, amber orange (most prominent)
\renewcommand{\cftchapfont}{\bfseries\Large\color{primaryamber!95!black}}
\renewcommand{\cftchappagefont}{\bfseries\Large\color{primaryamber!95!black}}
\renewcommand{\cftchapleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftchapdotsep}{\cftdotsep}
\renewcommand{\cftchapafterpnum}{\hspace{0.8em}}

% Section styling - Medium, bold, cyber blue (secondary level)
...
% Subsection styling - Small, regular weight, blue-gray (tertiary level)
\renewcommand{\cftsubsecfont}{\small\color{cyberblue!75!black}}
\renewcommand{\cftsubsecpagefont}{\small\color{cyberblue!75!black}}
\renewcommand{\cftsubsecleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftsubsecdotsep}{\cftdotsep}
\renewcommand{\cftsubsecafterpnum}{\hspace{0.3em}}

% Subsubsection styling - Very small, muted gray (quaternary level)
\renewcommand{\cftsubsubsecfont}{\footnotesize\color{black!65}}
\renewcommand{\cftsubsubsecpagefont}{\footnotesize\color{black!65}}
\renewcommand{\cftsubsubsecleader}{\cftdotfill{\cftdotsep}}

% Enhanced spacing and indentation for clear hierarchy
\setlength{\cftbeforechapskip}{1.8em}
\setlength{\cftafterchapskip}{1em}
\setlength{\cftbeforesecskip}{0.7em}
\setlength{\cftaftersecskip}{0.5em}
\setlength{\cftbeforesubsecskip}{0.4em}
\setlength{\cftaftersubsecskip}{0.3em}

% Width settings for proper alignment
\setlength{\cftchapnumwidth}{4.5em}
\setlength{\cftsecnumwidth}{3.5em}
\setlength{\cftsubsecnumwidth}{4.5em}
\setlength{\cftsubsubsecnumwidth}{5.5em}

% Indentation for clear visual hierarchy
\setlength{\cftsecindent}{3.5em}
\setlength{\cftsubsecindent}{6.5em}
\setlength{\cftsubsubsecindent}{9.5em}

% Enhanced dot leaders with amber color for visual appeal
\renewcommand{\cftdotsep}{3}
\renewcommand{\cftdot}{\textcolor{primaryamber!50}{$\cdot$}}

% Visual separation between entries
\renewcommand{\cftchapaftersnum}{\hspace{0.8em}}
\renewcommand{\cftsecaftersnum}{\hspace{0.5em}}
\renewcommand{\cftsubsecaftersnum}{\hspace{0.3em}}
...
% CyberNexus Table of Contents (Beautiful Enhanced Design)
\newpage
\thispagestyle{plain}
\vspace*{-1.2cm}

% Beautiful TOC Header
\begin{center}
    \vspace{0.5cm}
    {\Huge\bfseries\color{primaryamber!95!black} Table of Contents\par}
    \vspace{0.5cm}
    \textcolor{primaryamber!70}{\rule{0.7\textwidth}{3pt}}
    \vspace{1.5cm}
\end{center}

% Enhanced TOC with better formatting and colors
\begingroup
\setlength{\parskip}{0pt}
\setlength{\parindent}{0pt}
% Add subtle background for better readability
\colorbox{primaryamber!3}{
    \parbox{\textwidth}{
        \vspace{0.3cm}
        \tableofcontents
        \vspace{0.3cm}
