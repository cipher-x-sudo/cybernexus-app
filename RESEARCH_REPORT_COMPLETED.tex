...
% TOC-specific colors (explicitly defined for better compatibility)
\definecolor{tocchapter}{RGB}{233,150,11}       % primaryamber!95!black
\definecolor{tocsection}{RGB}{6,164,191}        % cybercyan!90!black  
\definecolor{tocsubsection}{RGB}{118,78,209}    % cyberpurple!85!black
...
\fancyfoot[C]{\textcolor{textmuted}{\small\textbf{CyberNexus} Semister Term Project}}
...
\renewcommand{\cftchapfont}{\bfseries\Large\color{tocchapter}}
\renewcommand{\cftsecfont}{\normalsize\bfseries}
\renewcommand{\cftsubsecfont}{\small}
\renewcommand{\cftchapleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftsecleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftsubsecleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftchappagefont}{\bfseries\color{tocchapter}}
\renewcommand{\cftsecpagefont}{\bfseries\color{tocsection}}
\renewcommand{\cftsubsecpagefont}{\color{tocsubsection}}

% Apply colors to section and subsection text
\renewcommand{\cftsecfont}{\normalsize\bfseries\color{tocsection}}
\renewcommand{\cftsubsecfont}{\small\color{tocsubsection}}
...
% Patch to apply colors to section and subsection text entries
\makeatletter
% Patch \contentsline to add colors for sections and subsections
...
\renewcommand{\contentsline}[4]{%
  ...
  \else
    ...
    \def\temp@b{#1}%
    \ifx\temp@a\temp@b
      \old@contentsline{#1}{\textcolor{tocsection}{#2}}{#3}{#4}%
    \else
      \def\temp@a{subsection}%
      \ifx\temp@a\temp@b
        \old@contentsline{#1}{\textcolor{tocsubsection}{#2}}{#3}{#4}%
      \else
        \old@contentsline{#1}{#2}{#3}{#4}%
      \fi
    \fi
...
\begin{titlepage}
    ...
    % Title
    {\Large\bfseries\color{primaryamber!95!black} Semester Term Project Report: Custom DSA Implementation\par}
    
    \vspace{1cm}
    
    % Team Members Section
    {\large\color{black!75} Team Members:\par}
    \vspace{0.4cm}
    \begin{minipage}{0.6\textwidth}
        \centering
        \begin{tabular}{@{}l@{\hspace{1.5cm}}l@{}}
            \textcolor{black!85}{\textbf{Muhammad Huzaifa}} & \textcolor{black!70}{ID: 241110} \\
            \textcolor{black!85}{\textbf{Muhammad Abdullah}} & \textcolor{black!70}{ID: 242313} \\
            \textcolor{black!85}{\textbf{Muhammad Ozair}} & \textcolor{black!70}{ID: 242335} \\
        \end{tabular}
    \end{minipage}
    ...
    \begin{tcolorbox}[
        ...
        \begin{center}
            {\bfseries\large\color{primaryamber!95!black} Project Information}
        \end{center}
        \vspace{0.4cm}
        \begin{tabular}{@{}p{3cm}@{\hspace{1.2cm}}p{5cm}@{}}
            ...
            \textcolor{black!75}{\textbf{Submitted to:}} & \textcolor{black!95}{\textbf{Mr. Bilal Saleem Malik}} \\[0.4cm]
...
\footnotesize
\begin{longtable}{@{}p{1.4cm}p{2cm}p{3.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{2cm}@{}}
\toprule
...
\newcommand{\progressbar}[1]{%
    \begin{tikzpicture}[baseline=-0.5ex]
        \fill[success!30] (0,0) rectangle (4,0.4);
        \fill[success] (0,0) rectangle (#1*4/100,0.4);
        \draw[success,thick] (0,0) rectangle (4,0.4);
    \end{tikzpicture}%
}

\begin{itemize}[leftmargin=*,itemsep=1em]
    \item \textbf{Week 1:} Requirements \& Design \hfill \progressbar{100} \textcolor{success}{\textbf{100\%}}
    \item \textbf{Week 2:} Core DSA Implementation \hfill \progressbar{100} \textcolor{success}{\textbf{100\%}}
    \item \textbf{Week 3:} Backend API \& Collectors \hfill \progressbar{100} \textcolor{success}{\textbf{100\%}}
    \item \textbf{Week 4:} Frontend GUI Development \hfill \progressbar{100} \textcolor{success}{\textbf{100\%}}
    \item \textbf{Week 5:} Integration \& Testing \hfill \progressbar{100} \textcolor{success}{\textbf{100\%}}
    \item \textbf{Week 6:} Documentation \& Deployment \hfill \progressbar{100} \textcolor{success}{\textbf{100\%}}
\end{itemize}

\vspace{0.5em}
\textbf{Overall Progress}: \progressbar{100} \textcolor{success}{\textbf{100\% Complete}}
...
\begin{enumerate}
    \item Li, Z., Zeng, J., Chen, Y., \& Liang, Z. (2021). \href{https://arxiv.org/abs/2111.07093}{"AttacKG: Constructing Technique Knowledge Graph from Cyber Threat Intelligence Reports."} arXiv preprint arXiv:2111.07093.
    
    \item Bkakria, A., Cuppens, N., \& Cuppens, F. (2020). \href{https://eprint.iacr.org/2020/422}{"Pattern Matching on Encrypted Data."} IACR Cryptology ePrint Archive, Report 2020/422.
    
    \item Wang, J., Zhu, T., Xiong, C., \& Chen, Y. (2024). \href{https://arxiv.org/abs/2411.08359}{"MultiKG: Multi-Source Threat Intelligence Aggregation for High-Quality Knowledge Graph Representation of Attack Techniques."} arXiv preprint arXiv:2411.08359.
    
    \item Kanka, V., Bairi, A. R., \& Mohammed, A. S. (2022). \href{https://thesciencebrigade.org/jst/article/view/567}{"Graph-Based AI/ML Algorithms for Real-Time Security Event Correlation and Attack Campaign Detection."} \textit{Journal of Science \& Technology}, 3(6), 113--156.
    
    \item \href{https://fastapi.tiangolo.com/}{FastAPI Documentation} (2024). \textit{FastAPI: Modern, Fast Web Framework for Building APIs}.
    
    \item \href{https://www.postgresql.org/docs/15/}{PostgreSQL Global Development Group} (2024). \textit{PostgreSQL 15 Documentation}.
    
    \item \href{https://nextjs.org/docs}{Next.js Team} (2024). \textit{Next.js 14 Documentation}.
    
    \item Cormen, T. H., Leiserson, C. E., Rivest, R. L., \& Stein, C. (2022). \href{https://mitpress.mit.edu/9780262046305/introduction-to-algorithms/}{\textit{Introduction to Algorithms}} (4th ed.). MIT Press.
    
    \item Sedgewick, R., \& Wayne, K. (2023). \href{https://www.pearson.com/en-us/subject-catalog/p/algorithms/P200000003499/9780137546357}{\textit{Algorithms}} (5th ed.). Addison-Wesley Professional.
    
    \item \href{https://www.recordedfuture.com/}{Recorded Future} (2024). \textit{Threat Intelligence Platform}.
    
    \item \href{https://threatconnect.com/}{ThreatConnect} (2024). \textit{Threat Intelligence Platform}.
    
    \item \href{https://www.anomali.com/}{Anomali} (2024). \textit{Threat Intelligence Solutions}.
    
    \item \href{https://networkx.org/}{NetworkX Development Team} (2024). \textit{NetworkX: Network Analysis in Python}.
    
    \item \href{https://redis.io/}{Redis Labs} (2024). \textit{Redis: In-Memory Data Structure Store}.
    
    \item \href{https://www.sqlalchemy.org/}{SQLAlchemy Development Team} (2024). \textit{SQLAlchemy: The Python SQL Toolkit}.
\end{enumerate}
